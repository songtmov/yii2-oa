...
$this->title = <?="Yii::t('common',"?><?= $generator->generateString(Inflector::pluralize(Inflector::camel2words(StringHelper::basename($generator->modelClass)))) ?><?=")"?>;
...
<?php endif; ?>
    ...
    <p class="clearfix">
        <?= "<?= " ?>Html::a('<i class="fa fa-plus"></i> '.<?="Yii::t('common',"?><?= $generator->generateString('Create ' . Inflector::camel2words(StringHelper::basename($generator->modelClass))) ?><?=")"?>, ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?="<?php "?> endif?>
