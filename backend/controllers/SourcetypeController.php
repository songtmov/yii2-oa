...
use backend\models\SourceType as SourceTypeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * SourcetypeController implements the CRUD actions for SourceType model.
 */
class SourcetypeController extends Controller
{
    ...
    {
        $searchModel = new SourceTypeSearch();
