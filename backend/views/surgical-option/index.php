...
/* @var $searchModel backend\models\SurgicalOption */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','手术方式');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="surgical-option-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    <?php  if(Helper::checkRoute('create')):?>
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','创建手术方式'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
