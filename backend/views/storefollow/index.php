...
use backend\models\StoreFollow;

/* @var $this yii\web\View */
/* @var $searchModel backend\models\StoreFollow */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','美容院跟进列表');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="store-follow-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    <?php  if(Helper::checkRoute('create')):?>
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','创建美容院跟进情况'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value'=>function($model){
                    return StoreFollow::$cooperation[$model->cooperation];
                }
            ],
            'fail_reason',
            [
