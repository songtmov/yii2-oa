...
/* @var $searchModel backend\models\photoType */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','图片类型');
...
<div class="photo-type-index">
    ...
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','新建图片类型'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
