...
/* @var $searchModel backend\models\Cstore */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','店家列表');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="cstore-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    <?php  if(Helper::checkRoute('create')):?>
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','　新建店家'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            // 'store_photo',
            // [
            //     'attribute'=>'store_photo',
            //     'format' => 'html',
            //     'value' => function($model){
            //         return Html::img($model->store_photo,['width'=>100]);
            //     }
            // ],
            'boss',
            // 'boss_photo',
            // [
            //     'attribute'=>'boss_photo',
            //     'format' => 'html',
            //     'value' => function($model){
            //         return Html::img($model->boss_photo,['width'=>100]);
            //     }
            // ],
            'encamp',
            'consultation',
