...
/* @var $searchModel backend\models\CustomerType */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','客户类型');
...
<div class="customer-type-index">
    ...
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','新建客户类型'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
