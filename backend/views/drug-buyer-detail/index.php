...
/* @var $searchModel backend\models\DrugBuyerDetail */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','Drug Buyer Details');
...
<?php endif?>
<div class="drug-buyer-detail-index">
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                   ...
                   return $model->order->status ==136? Html::input('text','Leechdom['.$model->leechdom_id.']',$model->number,['class'=>'form-control']):$model->number;
