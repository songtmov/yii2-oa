...
/* @var $searchModel backend\models\RecoverService */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','顾客术后调查列表');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="recover-service-index">
    
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    <?php  if(Helper::checkRoute('create')):?>
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','创建顾客术后调查'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
