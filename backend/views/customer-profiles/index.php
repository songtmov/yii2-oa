...
/* @var $searchModel backend\models\CustomerProfiles */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','档案列表');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="customer-profiles-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    <?php  if(Helper::checkRoute('create')):?>
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','创建一个新的档案'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
