...
/* @var $searchModel backend\models\Notpunch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','未打卡管理列表');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="notpunch-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    <?php  if(Helper::checkRoute('create')):?>
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','　创建未打卡'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value'=>function($model){
                    ...
                    return Html::a($state[$model->not_punch_interval],'javascript:',['class'=>$model->not_punch_interval == 1 ? 'btn btn-success btn-sm':'btn btn-danger']);
                },
                'filter'=>Html::activeDropDownList(
                    $searchModel,
                    'not_punch_interval',
                    [1=>Yii::t('common','上午'),0=>Yii::t('common','下午')],
