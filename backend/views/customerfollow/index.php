...
/* @var $searchModel backend\models\CustomerFollow */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','客户跟进列表');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="customer-follow-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    <?php  if(Helper::checkRoute('create')):?>
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','创建客户跟进'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
