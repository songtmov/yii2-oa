...
/* @var $searchModel backend\models\OutboundOrder */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','物品出库列表');
...
<div class="outbound-order-index">
    ...
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','新增物品出库'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
