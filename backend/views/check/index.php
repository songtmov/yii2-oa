...
/* @var $searchModel backend\models\Check */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','盘点管理');
...
<div class="check-index">
    ...
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','创建盘点'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'remark:ntext',
            ['attribute' =>'time','value' => function($model){
                // return date('y-m-d',strtotime($model -> time));
                return $model->time;
            }],
