...
/* @var $searchModel backend\models\Store */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','医院列表');
...
<div class="store-index">
    ...
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','新增医院'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'name',
            // [
            //     // 'attribute'=>'Store_image',
            //     // 'format' => 'html',
            //     // 'value' => function($model){
            //     //     return Html::img($model->Store_image,['width'=>50]);
            //     // }
            // ],
            'province',
            [
            ...
            [
                ...
                'attribute'=>'store_created_time',
                'value'=>function($model){
                    return date('Y-m-d',$model->store_created_time);
                }
            ],
