...
/* @var $searchModel backend\models\Supplies */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','Supplies');
...
<div class="supplies-index">
    ...
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','添加耗材 '), ['add'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
