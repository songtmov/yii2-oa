...
/* @var $searchModel backend\models\CaseManagement */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','病历列表');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="case-management-index">

    <form action="/casemanagement/search" method="post">
        <input name="_csrf" type="hidden" value="<?= Yii::$app->request->csrfToken ?>">
        <input type="text" name="client_name" placeholder="输入客户名查询病例" class="form-control" id="exampleInputEmail1"><br>
    ...
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','新增病历'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    return '<a href="/'.$model->path.'">点击下载</a>';
                }
            ],
            [
            ...
            'buttons' => [
                'update'=> function($url,$model,$key){
                    return Html::a(Yii::t('common','备注'),$url,['class'=>'btn btn-primary btn-sm']);
                },
