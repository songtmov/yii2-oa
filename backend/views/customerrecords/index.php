...
/* @var $searchModel backend\models\CustomerRecords */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','客户术后回访管理');
...
<div class="customer-records-index">
    ...
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','创建客户术后回访'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    return CustomerRecords::$static[$model->visited_mode];                 
                }
            ...
            [
                'attribute' => 'ishealthy',
                'value' => function($model){
                    return CustomerRecords::$healthy[$model->visited_mode];                 
                }
