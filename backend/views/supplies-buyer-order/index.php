...
/* @var $searchModel backend\models\SuppliesBuyerOrder */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','Supplies Buyer Orders');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="supplies-buyer-order-index">
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    return SuppliesBuyerOrder::$state[$model->status];
                }
            ],
            ...
            'buttons' => [
                'update'=> function($url,$model,$key){
                     return Html::button('采购详情',['value' => Url::to(['/supplies-buyer-detail/index','id'=>$model->id]), 'class' => 'btn btn-primary btn-sm ModalButton']);
                },
