...
/* @var $searchModel backend\models\DepositForm */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','定金管理列表');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="deposit-form-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    <?php  if(Helper::checkRoute('create')):?>
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','创建定金事项'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    return DepositForm::$static[$model->payment_method];
                }
            ],
            // 'payment_method',
