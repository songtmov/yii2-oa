...
/* @var $searchModel backend\models\Photos */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','图片事项列表');
...
<div class="photos-index">
    ...
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','新增图片事项'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    return '<img src="'.$model->path.'" style="width:50px;">';
                }
            ],
            'photo_name',
            // 'photo_type',
