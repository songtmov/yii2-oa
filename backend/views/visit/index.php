...
/* @var $searchModel backend\models\CustomerVisit */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','Customer Visits');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="customer-visit-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    <?php  if(Helper::checkRoute('create')):?>
    <!-- <p class="clearfix"> -->
        <!-- <?//= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','Create Customer Visit'), ['create'], ['class' => 'btn btn-success pull-right']) ?> -->
    <!-- </p> -->
    <?php  endif?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value'=>function($model){
                    return $model->status == 0?Html::a('等待回访','javascript:',['class'=>'btn btn-danger btn-sm']):
                        Html::a('已经回访','javascript:',['class'=>'btn btn-success btn-sm']);
                }
            ],
            ...
            [
                ...
                'value' => function($model){
                    return date('Y-m-d H:i:s',$model->to_store_time);
                }
            ],
            ...
            'buttons' => [
                ...
                'update'=> function($url,$model,$key){
                    $url = Url::to(['return-visit/create','id'=>$model->id,'uid'=>$model->customer_id]);;
                    $url2 = Url::to(['return-visit/view','id'=>$model->id]);;
                    return $model->status == 0 ? Html::a('回访',$url,['class'=>'btn btn-primary btn-sm']):
                            Html::a('查看回访',$url2,['class'=>'btn btn-success btn-sm']);
                },
