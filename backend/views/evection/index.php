...
/* @var $searchModel backend\models\Evection */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','Evections');
$this->params['breadcrumbs'][] = $this->title;

?>
<div class="evection-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    <?php  if(Helper::checkRoute('create')):?>
    <p class="clearfix">
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('common','Create Evection'), ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?php  endif?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    return data::getRegion([$model->province,$model->city]);
                }
            ],
            [
                'attribute' => 'user_id',
            ...
            'evection_info',
            [
                'attribute' => 'evection_img',
                'headerOptions'=>['width'=>100],
                'format' => 'raw',
                'value' => function($model){
                    return Html::img($model->evection_img,['width'=>80]);
                }
            ],
            // 'created_time',
            // 'updated_time',
