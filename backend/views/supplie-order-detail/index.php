...
/* @var $searchModel backend\models\SupplieOrderDetail */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('common','Supplie Order Details');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="supplie-order-detail-index">
    ...
    <div class="batch">
        ...
        <!-- <?
        // =  Html::a('确认发放', ['/supplie-order/grant','id'=>Yii::$app->request->get('id')], 
        // [
